...
<head>
    ...
    <title>Areyouchitect | Your Leading Technical Architect Consultation Network</title>
...
<div class="pagepiling">
    ...
    <div class="pp-scrollable scrollable-home text-white section">
        <div class="scroll-wrap">
            <div class="section-bg" style="background-image:url(https://picsum.photos/1920/1080.webp/?blur);"></div>
                                ...
                                <div class="intro">
                                    <div class="row">
                                        <div class="col-md-8 col-lg-6">
                                            ...
                                            <h1 class="display-1 text-white"><span class="text-primary">Imagining</span>
                                                IS key to more creative</h1>
                                ...
                                <div class="intro">
                                    <div class="row">
                                        <div class="col-md-5 col-lg-5">
                                            ...
                                            <h2 class="title-uppercase">Our mission is<br> <span class="text-primary">design & develop</span>
                                                the best interior<br> around</h2>
                                        ...
                                        <div class="col-md-6 col-lg-5 col-md-offset-1 col-lg-offset-2">
                                            <div class="dots-image-2">
                                                <img alt="" class="img-responsive" src="https://picsum.photos/470/490.webp/">
                                                <div class="dots"></div>
    ...
    <div class="pp-scrollable scrollable-projects text-white section">
        <div class="scroll-wrap">
            <div class="bg-changer">
                <div class="section-bg" style="background-image:url(https://picsum.photos/680/680.webp/?blur=2);"></div>
                <div class="section-bg" style="background-image:url(https://picsum.photos/680/680.webp/?blur=2);"></div>
                <div class="section-bg" style="background-image:url(https://picsum.photos/680/680.webp/?blur=2);"></div>
                <div class="section-bg" style="background-image:url(https://picsum.photos/680/680.webp/?blur=2);"></div>
                <div class="section-bg" style="background-image:url(https://picsum.photos/680/680.webp/?blur=2);"></div>
                                                    ...
                                                    <div id="project1" class="container zoom-anim-dialog mfp-hide">
                                                        <div class="row">
                                                            <div class="col-lg-8"><img alt="" class="project-detail-img"
                                                                                       src="https://picsum.photos/680/680.webp">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <h3 class="project-detail-title">UCAM Minimalist
                                                                    Apartment</h3>
                                                                <p class="project-detail-text">Lorem ipsum dolor sit
                                                                    amet, consectetuer adipiscing elit, sed diam nonummy
                                                                    nibh euismod tincidunt ut. magna aliquam erat
                                                                    volutpat enim ad minim veniam. Duis autem vel eum
                                                ...
                                                <div class="col-project-box col-sm-6 col-md-4 col-lg-3">
                                                    ...
                                                    <div id="project2" class="container zoom-anim-dialog mfp-hide">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <h3 class="project-detail-title">Scadinavan Living
                                                                    Room</h3>
                                                                <p class="project-detail-text">Lorem ipsum dolor sit
                                                                    amet, consectetuer adipiscing elit, sed diam nonummy
                                                                    nibh euismod tincidunt ut. magna aliquam erat
                                                ...
                                                <div class="col-project-box col-sm-6 col-md-4 col-lg-3">
                                                    ...
                                                    <div id="project3" class="container zoom-anim-dialog mfp-hide">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <h3 class="project-detail-title">Office For Fashion
                                                                    Brand Store</h3>
                                                                <p class="project-detail-text">Lorem ipsum dolor sit
                                                                    amet, consectetuer adipiscing elit, sed diam nonummy
                                                                    nibh euismod tincidunt ut. magna aliquam erat
                                                ...
                                                <div class="col-project-box col-sm-6 col-md-4 col-lg-3">
                                                    ...
                                                    <div id="project5" class="container zoom-anim-dialog mfp-hide">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <h3 class="project-detail-title">Living Room
                                                                    Germnay</h3>
                                                                <p class="project-detail-text">Lorem ipsum dolor sit
                                                                    amet, consectetuer adipiscing elit, sed diam nonummy
                                                                    nibh euismod tincidunt ut. magna aliquam erat
                                                ...
                                                <div class="col-project-box col-sm-6 col-md-4 col-lg-3">
                                                    ...
                                                    <div id="project6" class="container zoom-anim-dialog mfp-hide">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <h3 class="project-detail-title">The Luxury Interior
                                                                    Design</h3>
                                                                <p class="project-detail-text">Lorem ipsum dolor sit
                                                                    amet, consectetuer adipiscing elit, sed diam nonummy
                                                                    nibh euismod tincidunt ut. magna aliquam erat
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row-partners">
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_1.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_2.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_3.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_4.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_5.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_6.png">
                                                    </div>
                                                </div>
                                                <div class="col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/_1.png">
                                ...
                                <div class="intro">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-5">
                                            ...
                                            <h2 class="title-uppercase text-white">creative & dedicated is things that
                                                bauhaus studio brings for your house</h2>
                                        </div>
                                                ...
                                                <div class="review-carousel-item">
                                                    <div class="text">
                                                        <p>“ If you are seeking an Interior designer that will
                                                            understand exactly your needs, and someone who will utilise
                                                            their creative and technical skills in parity with your
                                                            taste, then Suzanne at The Bauhaus Studio is perfect.</p>
                                                ...
                                                <div class="review-carousel-item">
                                                    <div class="text">
                                                        <p>“ Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Sequi voluptates officia molestias fugit ipsum, blanditiis
                                                            minima voluptatibus sit in laudantium doloribus, illum,
                                                            reiciendis similique distinctio asperiores earum dolore
                                                            eveniet eius."</p>
                                                        <p> Thank you so much for all your design and expertise."</p>
                                                    </div>
                                                    <div class="review-author">
